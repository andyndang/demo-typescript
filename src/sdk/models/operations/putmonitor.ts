...
export class PutMonitorSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=X-API-Key" })
    apiKeyAuth: string;
}

export class PutMonitorRequest extends SpeakeasyBase {
...
export class PutMonitorResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
