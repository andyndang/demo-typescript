...
export class PartiallyUpdateOrgSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=X-API-Key" })
    apiKeyAuth: string;
}

export class PartiallyUpdateOrgRequestBody extends SpeakeasyBase {
    /**
...
export class PartiallyUpdateOrgRequest extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "request, media_type=application/json" })
    requestBody: PartiallyUpdateOrgRequestBody;
...
export class PartiallyUpdateOrgResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
