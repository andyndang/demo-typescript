...
export class PartiallyUpdateOrganizationSecurity extends SpeakeasyBase {
    @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header;name=X-API-Key" })
    apiKeyAuth: string;
}

export class PartiallyUpdateOrganizationRequest extends SpeakeasyBase {
    /**
...
export class PartiallyUpdateOrganizationResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
